...
local db_Cached_File_nds = (db_Cache_Folder .. "db_nds.lua")
...
function print_tables()
    ...
    local db_nds = assert(io.open(db_Cached_File_nds, "w"))
    printTable(nds_table, db_nds)
    db_nds:close()
